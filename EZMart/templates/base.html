                      ...
                      <span>
                        ...
                        <p>
                          <a class="btn btn-secondary" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                            <i class="fa fa-user-plus" aria-hidden="true">  Register</i>
                          </a>
                        </p>
                        <div class="collapse" id="collapseExample" >
                          <div class="card card-body" style="background-color:gray">
                            <a href="{% url 'registercustomer' %}" class="register-link">
                        <i class="fa fa-user-plus" aria-hidden="true"></i>
                      <span>
                        Customer
                      </span>
                    </a>
                    <a href="{% url 'registerbusiness' %}" class="register-link">
                    <i class="fa fa-user-plus" aria-hidden="true"></i>
                      <span>
                        Business
                      </span>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="info_contact">
            <h5>
              <a href="admin" class="register-link">
